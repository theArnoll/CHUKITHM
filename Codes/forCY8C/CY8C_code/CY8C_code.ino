...
void sendSPI(uint8_t latchPin, uint8_t dataPin, uint8_t clockPin, uint8_t data) {
...
void requestTouchStatus(uint8_t statusStorage[2][2])
{
    ...
    if (error != 0)
    {
        ...
        switch(error)
        {
            case 1: pixels.setPixelColor(0, pixels.Color(255, 0, 0)); pixels.show(); break; // red
            case 2: pixels.setPixelColor(0, pixels.Color(0, 255, 0)); pixels.show(); break; // green
            case 3: pixels.setPixelColor(0, pixels.Color(0, 0, 255)); pixels.show(); break; // blue
            case 4: pixels.setPixelColor(0, pixels.Color(255, 255, 0)); pixels.show(); break; // yellow
            case 5: pixels.setPixelColor(0, pixels.Color(255, 0, 255)); pixels.show(); break; // purple
            default: pixels.setPixelColor(0, pixels.Color(255, 255, 255)); pixels.show(); break; // white
        }
...
void printError(uint8_t errorCode)
{
    ...
    switch (errorCode)
    {
        ...
        case 5: Serial.println("5: Timeout Error"); break;
        default:
